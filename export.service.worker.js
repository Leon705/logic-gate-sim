...
/** @type {string} */
const CACHE_VERSION = '1771710046|30034697490';
/** @type {string} */
const CACHE_PREFIX = 'LogicGateSim-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'export.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["export.html","export.js","export.offline.html","export.icon.png","export.apple-touch-icon.png","export.audio.worklet.js","export.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["export.wasm","export.pck"];
